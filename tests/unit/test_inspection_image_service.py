...
def test_normalize_cloudfront_image_urls_preserves_order_and_removes_duplicates():
    ...
    result = normalize_cloudfront_image_urls([cover_url, inside_url, cover_url])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["https://d3j61tpuly7r0p.cloudfront.net/private/book.jpg"],
        ["https://d3j61tpuly7r0p.cloudfront.net/uploads/../private/book.jpg"],
        ["https://d3j61tpuly7r0p.cloudfront.net/uploads/"],
        ["https://user@d3j61tpuly7r0p.cloudfront.net/uploads/book.jpg"],
        ["https://d3j61tpuly7r0p.cloudfront.net:443/uploads/book.jpg"],
        ["https://d3j61tpuly7r0p.cloudfront.net/uploads/book.jpg?expires=1"],
        ["https://d3j61tpuly7r0p.cloudfront.net/uploads/book.jpg#preview"],
        ["https://d3j61tpuly7r0p.cloudfront.net/uploads/book.pdf"],
    ],
)
