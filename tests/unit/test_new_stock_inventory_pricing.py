...
def test_new_stock_default_price_applies_ten_percent_discount():
    discount_rate, sale_price = calculate_new_stock_default_price(Decimal("18000.00"))
...
def test_new_stock_inventory_has_pricing_columns_and_constraints():
    ...
    check_names = {constraint.name for constraint in Inventory.__table__.constraints if constraint.name is not None}
