...
- `[ ]` **[BE-1.2]** S3 Pre-signed URL 발급 API 개발 및 통합 (@고영빈(Sub))
...
|:---:|:---:|---|---|---|:---:|
| **장문경** | PM-1.2, BE-2.3 | EKS 클러스터 블루프린트 및 파이프라인(buildspec.yml) 자동화 설계 완료 | 클라우드 계정 생성 대기 및 팀원 서포트 | 없음 | - |
| **박민우** | BE-1.1 | DB 스키마 설계 및 PostgreSQL 연동 | BE-1.1 진행 | 없음 | - |
